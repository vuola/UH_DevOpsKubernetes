<?php
        ...
        public function getTasks(){
            $sqlQuery = "SELECT id, description, owner, status, created FROM " . $this->db_table . "";
        ...
        // GET X LATEST TASKS
        public function getLatestTasks($len){
            $sqlQuery = "SELECT
                        id, 
                        description, 
                        owner, 
    ...
    class ClientTask extends Task {
        ...
        public function __construct($api_ulr) {
